...
const SignupPage = () => {
  ...
  const { signup, googleLogin } = useStore();
        ...
        <div className="glass rounded-2xl p-6 shadow-2xl border border-white/10">
          ...
          <div className="mt-4">
            ...
            <div className="mt-3 grid grid-cols-3 gap-2">
              <button onClick={handleGoogleLogin} className="flex items-center justify-center space-x-1 py-1.5 px-2 bg-gray-800/50 border border-gray-700 rounded-lg hover:bg-gray-700/50 transition-colors">
